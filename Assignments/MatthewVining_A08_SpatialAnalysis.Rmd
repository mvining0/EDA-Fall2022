...
>ANSWER: the "dec_long_va" and "dec_lat_va" columns dissapeared and appear to have merged into the column titled "geometry". 
>
...
ggplot() +
  geom_sf(data = NE_counties_sf,color='red') + 
  geom_sf(data = gage_sf_join,aes(fill = gage_ht),alpha=0.3) +
  scale_fill_gradient2(low='orange',high='purple',midpoint = 20) +
  labs(title = "NWIS Gage Locations in Nebraska", subtitle = "Matthew Vining")
