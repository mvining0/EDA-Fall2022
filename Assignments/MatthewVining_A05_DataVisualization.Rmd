...
factor(Nutrients$month, levels=c(1:12))
...
month.abb[Nutrients$month]
plot_grid(Plot_P5.temp, Plot_P5.tn, Plot_P5.tp, align = 'hv', axis = 'b', common.legend = TRUE) + scale_x_discrete(month, drop=FALSE)
```
