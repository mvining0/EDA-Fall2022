...
#2
DEQwebpage <- read_html('https://www.ncwater.org/WUDC/app/LWSP/report.php?pwsid=03-32-010&year=2021')
DEQwebpage
...
pswid <- '03-32-010'
Year <- 2021
DEQwebpage <- paste0(the_base_url, pswid, '&year=', Year)
print(DEQwebpage)

scrape.it <- function(Year, pswid){
  
  #Retrieve the website contents 
  DEQwebpage <- read_html(paste0('https://www.ncwater.org/WUDC/app/LWSP/report.php?pwsid=', pswid, '&year=', Year))
...
ggplot(extract.df,aes(x=Date,y=max.withdrawals.mgd)) + 
  geom_line(aes(group=1)) +
  labs(title = paste("2015 Maximum Daily Water Withdrawls"),
       subtitle = "Matthew Vining",
       y="Withdrawal (mgd)",
       x="Date")
...
ggplot(extract.df2,aes(x=Date,y=max.withdrawals.mgd)) + 
  geom_line(aes(group=1)) +
  labs(title = paste("2015 Maximum Daily Water Withdrawls"),
       subtitle = "Matthew Vining",
       y="Withdrawal (mgd)",
...
ggplot(total_extract,aes(x=Date)) + 
  ...
  labs(title = paste("2015 Maximum Daily Water Withdrawls for Asheville and Durham"),
       subtitle = "Matthew Vining",
       y="Withdrawal (mgd)",
       x="Date")
