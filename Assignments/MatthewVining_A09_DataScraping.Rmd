...
pswid <- '03-32-010'
the_year <- 2021
the_scrape_url <- paste0(the_base_url, pswid, '&year=', Year)
...
pswid <- '03-32-010'
Year <- 2015
extract.df <- scrape.it(Year,pswid)
extract.df
...
#8
extract.df2 <- scrape.it(2015,'01-11-010')
extract.df2

rbind(extract.df, extract.df2)
