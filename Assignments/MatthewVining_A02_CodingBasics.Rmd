...
names(test_dataframe) <- c("Name","Test Score","Pass/Fail"); View(test_dataframe) # labeled columns of data
```
...
> Answer: ifelse worked the best because it was easier to write. However, both types worked and gave the same output.
