...
USGS.flow.data <- read.csv("./Data/Raw/USGS_Site02085000_Flow_Raw.csv", stringsAsFactors = TRUE) #looks at column data types and assigns characters that are not numbers as characters/factors   
