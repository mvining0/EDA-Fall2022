...
* **Spearman Rho**: no seasonality, non-parametric, missing data allowed. Function: `cor.test(method="spearman")` (package: stats). Can detect non linear trends.

Specific test for stochastic trend analysis:

* **Augmented Dickey Fuller**: no seasonality, non-parametric, missing data not allowed. Function: `adf.test()` (package: tseries). Can also detect stochastic trends, while also check monotonic. 



If ADF is positive, dont run man kendall test, just say stochastic trend.
